...
function createFastfetchAsciiArt(asciiArtText, storedImageHref) {
    ...
    if (url) {
        ...
        stack.classList.add('terminal-fastfetch-art-stack--photo');
...
async function runFastfetchPanel() {
    ...
    const updateFastfetchArtScale = () => {
        ...
        if (stack.classList.contains('terminal-fastfetch-art-stack--photo')) {
            panel.style.setProperty('--fastfetch-art-scale-x', '1');
            panel.style.setProperty('--fastfetch-art-scale-y', '1');
